...
var Bound = function (_Component) {
  ...
  _createClass(Bound, [{
    ...
    value: function renderChildren(props, state) {
      ...
      return React.Children.map(props.children, function (node) {
        ...
        if (nodeTypes.includes(type)) {
          ...
          var clonedElement = React.cloneElement(node, cloneProps);
          return clonedElement;
        } else {
          if (props) {
            return React.createElement(type, props, _this2.renderChildren(props, state));
          }
